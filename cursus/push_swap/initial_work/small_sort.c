...
/*   Updated: 2022/07/30 11:10:39 by hsarhan          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	sort_four(t_stack **stack_a, t_stack **stack_b)
{
	...
	rev = false;
	if (forward_distance_to_idx(stack_a, 0) > reverse_distance_to_idx(stack_a, 0))
		rev = true;
...
void	sort_five(t_stack **stack_a, t_stack **stack_b)
{
	...
	push(stack_a, stack_b, 'b');
	rev = false;
	if (forward_distance_to_idx(stack_a, 1) > reverse_distance_to_idx(stack_a, 1))
		rev = true;
