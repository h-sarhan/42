...
/*   Updated: 2022/06/22 19:47:47 by hsarhan          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int argc, char **argv, char **env)
{
	...
	first = command_list;
	ft_pipe(pipe_fds);
	handle_first_cmd(command_list->content, fds, pipe_fds, env);
	command_list = command_list->next;
	command_list = handle_mid_cmds(command_list, pipe_fds, fds, env);
